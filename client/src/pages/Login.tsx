...
import glassHouseImage from '@assets/generated_images/minimalist_modern_glass_house_architectural_model_on_white_background.png';
          ...
          <div className="space-y-5">
            ...
            >
              <div className="mr-4 flex items-center justify-center">
                <svg className="w-5 h-5 grayscale group-hover:grayscale-0 transition-all duration-300 opacity-60 group-hover:opacity-100" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
