      ...
      {navItems.map((item) => {
        ...
        const content = (
          <div className={cn(
            ...
            {(isSidebarOpen || mobile) && <span>{item.label}</span>}
          </div>
        );
  ...
  return (
    <div className="min-h-screen bg-background flex font-sans">
      ...
      >
        ...
        <div className={cn("p-4 border-t border-sidebar-border/10 space-y-10", !isSidebarOpen && "items-center flex flex-col p-2")}>
           {userType === 'client' ? (
        ...
        <header className="h-16 border-b bg-background flex items-center justify-between px-4 sticky top-0 z-20">
           ...
           <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 flex flex-col bg-sidebar text-sidebar-foreground border-r-sidebar-border">
                ...
                <div className="p-4 border-t border-sidebar-border/10 space-y-10 mt-auto">
                   {userType === 'client' ? (
                     <Link href="/client/profile">
