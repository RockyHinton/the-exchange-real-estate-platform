  ...
  return (
    <div className="min-h-screen bg-background flex font-sans">
      ...
      >
        ...
        <div className={cn("p-4 border-t border-sidebar-border/10 space-y-6", !isSidebarOpen && "items-center flex flex-col p-2")}>
           {userType === 'client' ? (
           ...
           <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[350px] p-0 flex flex-col bg-sidebar text-sidebar-foreground border-r-sidebar-border">
                ...
                <div className="p-4 border-t border-sidebar-border/10 space-y-6 mt-auto">
                   {userType === 'client' ? (
                     <Link href="/client/profile">
